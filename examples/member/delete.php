...
$listId = getenv('LP_EX_LIST_ID');
$memberIdToDelete = getenv('LP_EX_MEMBER_ID_TO_DELETE');
...
if (!$memberIdToDelete) {
    echo "Error: LP_EX_MEMBER_ID_TO_DELETE environment variable is not set. "
        . "Please set it to the ID of a member you wish to delete.\n";
    exit(1);
}
...
try {
    $result = $memberApi->delete($listId, $memberIdToDelete);
    echo "Member with ID '$memberIdToDelete' in list '$listId' deleted successfully:\n";
    print_r($result);
