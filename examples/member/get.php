...
if (!$memberId) {
    echo "Error: LP_EX_MEMBER_ID environment variable is not set. This is required to identify the member.\n";
    exit(1);
}
...
try {
    $result = $memberApi->get($listId, $memberId);
    echo "Member with ID '$memberId' in list '$listId' retrieved successfully:\n";
    print_r($result);
