...
$updateParams = [
    'html' => "<html lang='en'><head><title>Updated Title</title></head>"
        . "<body>This HTML content is updated at "
        . date('Y-m-d H:i:s')
        . ".</body></html>",
];
try {
    $result = $campaignApi->updateContent($campaignId, $updateParams);
    echo "Campaign content updated successfully for campaign_id '$campaignId':\n";
    print_r($result);
